package edu.whimc.overworld_agent.utils.sql.migration;

import edu.whimc.overworld_agent.OverworldAgent;
import edu.whimc.overworld_agent.utils.sql.migration.schemas.Schema_1;
...
public class SchemaManager {
    ...
    public SchemaManager(OverworldAgent plugin, Connection connection) {
        this.plugin = plugin;
